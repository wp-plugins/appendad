...
1. Upload the `appendad` folder to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress

= How to use =

1. AppendAd is available from the WordPress admin panel settings under the Plugins link.
1. Just enter the site ID you've been given from AppendAd's platform and hit the save changes button.
